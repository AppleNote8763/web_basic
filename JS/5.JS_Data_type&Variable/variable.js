...
*/
var varVariable = 10;       // 일반변수
let letVariable = 10;       // 일반변수
const constVariable = 10;   // 상수형변수
/*
...
/*
    var 키워드로 선언된 변수는 블록레벨 스코프가 아닌 함수 레벨의  스코프를 가짐
    - 함수 레벨 스코프 : 함수 내에서 선언된 변수는 함수 안에서 사용 가능, 함수 밖에선 사용 불가능
    - 블록 레벨 스코프 : 코드 블럭 내에서 선언된 변수는 해당 코드 블럭 내애세만 사용 가능, 코드 블럭 밖에선 사용 불가능
*/
