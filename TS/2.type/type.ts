...
let string1: string = '';       // 기본형 스트링(string)
let string2: String = '';       // 인터페이스타입 스트링(String)
string2 = string1;              // 기본형에 인터페이스를 넣음   가능
// string1 = string2;           // 인터페이스에 기본형을 넣음   불가능
...
funcType = func2;
// funcType = voidFunc;     //'() => void' 형식은 '(arg: string) => string' 형식에 할당할 수 없습니다. 'void' 형식은 'string' 형식에 할당할 수 없습니다.
