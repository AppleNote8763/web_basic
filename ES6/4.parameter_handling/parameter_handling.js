...
console.log(numbers);
console.log(...numbers);
const text = '...을 사용하여 대상의 요소를 하나씩 분리 연산자의 피연산자는 반드시 반복 가능한 객체(배열, 객체, 문자열, ...) 이어야 함'
console.log(...text);
...
newKing = {...king, name: '이단', birth: '1335-11-04'};     // 동일키 존재시 키의 밸류 값이 교체됨  name: '이성계' => name: '이단'
console.log(newKing);

newKing = {name: '이단', ...king, birth: '1335-11-04'};     // 동일키 존재시 키의 밸류 값이 교체됨  name: '이단' => name: '이성계'
console.log(newKing);